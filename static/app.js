...
const TRANSLATIONS = {
  en: {
    ...
    homeSpotlightTitle: 'Campus Spotlight',
    homeSpotlightText: 'A formal showcase of student-led work, archive highlights, and academic activity.',
    homeAnnouncementsLabel: 'Announcements',
    homeAnnouncementText: 'Student experiences, archive volumes, and current updates are highlighted below.',
  ...
  hi: {
    ...
    homeSpotlightTitle: 'कैम्पस स्पॉटलाइट',
    homeSpotlightText: 'छात्र-नेतृत्व वाले कार्य, आर्काइव हाइलाइट्स और शैक्षणिक गतिविधियों का औपचारिक प्रदर्शन।',
    homeAnnouncementsLabel: 'घोषणाएँ',
    homeAnnouncementText: 'छात्र अनुभव, आर्काइव वॉल्यूम और वर्तमान अपडेट नीचे दर्शाए गए हैं।',
