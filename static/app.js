...
const TRANSLATIONS = {
  en: {
    ...
    footerCopyright: '&copy; 2026 Anubhuti.',
    ...
    homeVisionText: 'To nurture young talent through experiential learning, holistic education and inclusive opportunities that empower students to contribute to society.',
    ...
    homeInstitutionLead: 'Explore student experiences, archives, and updates in one place.',
    homeExploreUpdates: 'Explore Updates',
    homeAnnouncementsLabel: 'Announcements',
    homeAnnouncementText: 'New submissions are open for internship reports, fieldwork journals, and community stories. Selected entries may be featured on the home page.',
    ...
    authSupportServices: 'Share your experience',
  ...
  hi: {
    ...
    footerCopyright: '&copy; 2026 अनुभूति।',
    ...
    homeAnnouncementsLabel: 'घोषणाएँ',
    homeAnnouncementText: 'इंटर्नशिप रिपोर्ट, फील्डवर्क जर्नल, और सामुदायिक कहानियों के लिए नए सबमिशन खुले हैं। चयनित प्रविष्टियाँ होम पेज पर प्रदर्शित की जा सकती हैं।',
